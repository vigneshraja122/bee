        ...
        <div className="w-full h-screen flex flex-col items-center" style={{ backgroundImage: "url('/Desktop - 4.svg')" }}>
            ...
            <div className="w-full h-full flex flex-col justify-center items-center">
                ...
                <div className="w-[80%] h-full flex flex-col justify-center items-center text-center">
                    <h1 className="text-4xl">World’s First AI-Powered Blockchain &<br/> Gaming Development Engine</h1>
                    <p>Where Blockchain, Crypto, Metaverse, and AI-Automation come together to build the future</p>
